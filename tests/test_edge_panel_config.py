...
class EdgePanelConfigTests(unittest.TestCase):
    ...
    def test_panel_exposes_active_version_for_runtime_diagnostics(self):
        ...
        self.assertEqual(panel.APP_VERSION, "0.10.29")
        self.assertEqual(panel.EdgeHandler.server_version, "EdgePanel/0.10.29")
        self.assertEqual(panel.health_payload()["server_version"], "EdgePanel/0.10.29")
        self.assertEqual(panel.collect_panel_logs()["server_version"], "EdgePanel/0.10.29")
        self.assertIn("v0.10.29", panel.INDEX_HTML)
    ...
    def test_nvr_timeline_does_not_rerender_during_active_playback(self):
        ...
        self.assertIn("day-wall-clock-diagnostics-v1", html)
